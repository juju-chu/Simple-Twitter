<template>
  <div class="user-cards-wrapper">
    <div class="user-card">
      <img
        class="user-cover"
        src="https://loremflickr.com/320/240/landscape/?lock=5.340210782676302"
        alt=""
      />
      <img
        class="user-avatar"
        src="https://loremflickr.com/320/240/dog/?lock=46.870022954520906"
        alt=""
      />
      <div class="user-profile">
        ...
        <div class="followship">
          <div class="followings-info">
            <span class="followship-count">34個</span>
            <span class="followship-unit">跟隨中</span>
          </div>
          <div class="followers-info">
            <span class="followship-count">59位</span>
